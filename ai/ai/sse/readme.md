...
vite 创建的vue项目 package.json (后端项目描述文件),node_modules 文件夹
vite 工程化, 是node 后端服务, 方便用于BFF 开发一下
...
- vite.config.js 解决方案 
  ...
  bff 后端提供了
    所有前端请求，vite都会被拦截
     ...
     代理一下请求，并转发出去
     :3000/stream
     :5173/api/stream(不跨越但502) -> vite proxy  /api -> :3000/stream
